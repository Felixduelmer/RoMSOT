...
def main():
    """
    Run the tilting analysis to reproduce the corresponding figures and metrics.

    Expects the tilting data to be located under `data/tilting/Scan_1` ... `Scan_7`.
    """
    # Define the main directory where the "Scan_X" folders are located
    main_dir = "data/tilting"
    ...
    compute_and_store_metrics(images, main_dir, "tilting")
